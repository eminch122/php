          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" onclick="display('sigProb')" >report a probleme</a></li>
                <li class="nav-item"> <a class="nav-link" onclick="display('probList')">view reports</a></li>
              </ul>
            </div>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" onclick="display('usersCal')">
              <i class="icon-grid menu-icon"></i>
